...
/**
 * Represents the Issue Order phase of the game. In this phase, players assign
 * orders such as deploying armies to their territories. In the State pattern,
...
public class IssueOrderPhase extends Phase {
	...
	private static final Set<String> VALID_COMMANDS = new HashSet<>(
			Arrays.asList("showmap", "deploy", "advance", "bomb", "blockade", "airlift", "negotiate"));
	 ...
	 * @param p_commandPromptView view handling user interactions through the
	 *                            command prompt
	 * @param p_commandParts      the command parts passed as input
	 * @param p_gameMap           the game map containing all territories and their
	 *                            connections
	 */
	@Override
