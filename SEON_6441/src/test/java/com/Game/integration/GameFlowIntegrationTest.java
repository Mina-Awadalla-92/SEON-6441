...
/**
 * Integration test class for the game flow.
 * Tests the interaction between controllers, models, and the game phases.
 */
public class GameFlowIntegrationTest {
    ...
    public void testMapCreation() {
        ...
        d_mapEditorController.handleCommand(new String[]{"editcontinent", "-add", "Continent1", "5"}, "editcontinent", true);
        d_mapEditorController.handleCommand(new String[]{"editcontinent", "-add", "Continent2", "3"}, "editcontinent", true);
        
        // Test adding countries
        d_mapEditorController.handleCommand(new String[]{"editcountry", "-add", "Country1", "Continent1"}, "editcountry", true);
        d_mapEditorController.handleCommand(new String[]{"editcountry", "-add", "Country2", "Continent1"}, "editcountry", true);
        d_mapEditorController.handleCommand(new String[]{"editcountry", "-add", "Country3", "Continent2"}, "editcountry", true);
        
        // Test adding neighbors
        d_mapEditorController.handleCommand(new String[]{"editneighbor", "-add", "Country1", "Country2"}, "editneighbor", true);
        d_mapEditorController.handleCommand(new String[]{"editneighbor", "-add", "Country2", "Country3"}, "editneighbor", true);
    ...
    public void testPlayerCreationAndAssignment() {
        ...
        for (Territory territory : d_gameMap.getTerritoryList()) {
            ...
            assertTrue("Territory owner should be a valid player", 
                      territory.getOwner().getName().equals("Player1") || 
    ...
    public void testReinforcementCalculation() {
        ...
        for (int i = 1; i <= 9; i++) {
            d_mapEditorController.handleCommand(
                new String[]{"editcountry", "-add", "Country" + i, "Continent1"}, "editcountry", true);
        }
        ...
        assertEquals("Player1 should have correct reinforcements based on territory count", 
                    3, player1.getNbrOfReinforcementArmies());
        assertEquals("Player2 should have minimum of 3 reinforcements", 
                    3, player2.getNbrOfReinforcementArmies());
    }
    ...
    public void testOrderCreationAndExecution() {
        ...
        Player player = new Player("TestPlayer", 5); // 5 reinforcement armies
