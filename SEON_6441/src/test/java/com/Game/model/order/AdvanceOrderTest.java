...
public class AdvanceOrderTest {
    ...
    public void setUp() {
        // Create players
        d_attacker = new Player("Attacker", 10);
        d_defender = new Player("Defender", 10);
    ...
    public void testCreateAdvanceMove() {
        ...
        assertEquals("Target territory should be set correctly", d_friendlyTargetTerritory, d_advanceMove.getD_territoryTo());
    ...
    public void testCreateAdvanceAttack() {
        ...
        assertEquals("Source territory should be set correctly", d_sourceTerritory, d_advanceAttack.getD_territoryFrom());
        assertEquals("Target territory should be set correctly", d_enemyTargetTerritory, d_advanceAttack.getD_territoryTo());
     ...
     * This test simulates a successful attack by directly manipulating the target territory.
     */
    @Test
    ...
    public void testAdvanceOrderValidation() {
        ...
        // This scenario would need a more complex test setup with the actual string command parsing logic
    ...
    public void testAdvanceMoveWithNeutralTerritory() {
        ...
        assertEquals("Neutral territory should have the advanced armies", ARMY_COUNT, neutralTerritory.getNumOfArmies());
    }
}