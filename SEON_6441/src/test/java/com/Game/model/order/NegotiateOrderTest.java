 ...
 * 
 * These tests verify that when a NegotiateOrder is executed:
 * - The target player is added to the issuer's negotiated players list.
 * - The issuer is added to the target player's negotiated players list.
 */
