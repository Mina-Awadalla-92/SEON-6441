...
public class TerritoryTest {
	...
	public void testCheckForWinner() {
		...
		com.Game.controller.GamePlayController gamePlayController = new com.Game.controller.GamePlayController(
				gameController, d_map, players);

		// This is a private method, so we'd need to use reflection or modify the code
		// to test it directly
		// Instead, we'll test the result indirectly through handleEndTurn, which won't
		// be called here

		// We could modify the code to make the checkForWinner method public or
