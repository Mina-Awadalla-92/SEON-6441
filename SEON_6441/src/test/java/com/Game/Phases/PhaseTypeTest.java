...
class PhaseTypeTest {
    ...
    @Test
    void testPhaseType_WhenRetrievingAllValues() {
    ...
    @Test
    void testPhaseType_WhenRetrievingByName() {
    ...
    @Test
    void testPhaseTypeValueOf_InvalidInput() {
        assertThrows(IllegalArgumentException.class, () -> PhaseType.valueOf("INVALID"),
            "PhaseType.valueOf should throw an exception for invalid input.");
    }

    @Test
    void testPhaseTypeValueOf_CaseSensitivity() {
        assertThrows(IllegalArgumentException.class, () -> PhaseType.valueOf("startup"),
            "PhaseType.valueOf should be case-sensitive.");
    }
