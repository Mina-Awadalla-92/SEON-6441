...
public class GamePlayControllerTest {
    ...
    void setUp() {
        ...
        d_randomMock = mock(Random.class);  // Mock the random object used for shuffling
        ...
        // Mock random behavior for territory shuffling
        when(d_randomMock.nextInt(anyInt())).thenReturn(0);  // Simple mock to avoid randomness during testing
    ...
    void testHandleAssignCountries() {
        ...
        // Mock random behavior for shuffling
        when(d_randomMock.nextInt(anyInt())).thenReturn(0); // Just to avoid shuffling, not important for this test
